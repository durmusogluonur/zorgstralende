...
export default function HuishoudelijkeHulpPage() {
  const [lang, setLang] = useState<Language>('nl');
  const t = getTranslation(lang);
  const service = t.services.huishoudelijkeHulp;

  // Placeholder images - will be replaced with real photos
  const galleryImages = [
    '/images/services/huishoudelijke-hulp/1.jpg',
    '/images/services/huishoudelijke-hulp/2.jpg',
    '/images/services/huishoudelijke-hulp/3.jpg',
  ];
        ...
        <div className="container mx-auto px-4">
          <MotionWrapper className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              {lang === 'nl' 
                ? 'Een kijkje in onze huishoudelijke hulp'
                : 'A look at our household help services'}
            </p>
          </MotionWrapper>
