...
export default function PersoonlijkeVerzorgingPage() {
  const [lang, setLang] = useState<Language>('nl');
  const t = getTranslation(lang);
  const service = t.services.persoonlijkeVerzorging;

  // Placeholder images - will be replaced with real photos
  const galleryImages = [
    '/images/services/persoonlijke-verzorging/1.jpg',
    '/images/services/persoonlijke-verzorging/2.jpg',
    '/images/services/persoonlijke-verzorging/3.jpg',
  ];
        ...
        <div className="container mx-auto px-4">
          <MotionWrapper className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              {lang === 'nl' 
                ? 'Een kijkje in onze persoonlijke verzorging'
                : 'A look at our personal care services'}
            </p>
          </MotionWrapper>
